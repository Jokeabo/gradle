...
package org.gradle.util.internal.configuration;
...
/**
 * NOTE: You should use {@link org.gradle.util.internal.ConfigureUtil} instead of this class when adding a closure backed method to the DSL, whether statically or dynamically added. {@link ConfigureUtil} is much more efficient and takes care of applying consistent DSL behaviour when closures are nested.
 */
